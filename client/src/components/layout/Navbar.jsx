      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <img src="/logo-navbar.png" alt="Logo BEM UMS" className="w-40 sm:w-56 h-auto max-h-14 object-contain drop-shadow-[0_0_10px_rgba(220,38,38,0.5)] group-hover:scale-105 transition-transform origin-left" />
          </Link>
